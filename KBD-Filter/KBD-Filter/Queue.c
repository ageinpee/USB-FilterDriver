...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, KBDFilterQueueInitialize)
#endif

NTSTATUS
KBDFilterQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = KBDFilterEvtIoDeviceControl;
    queueConfig.EvtIoStop = KBDFilterEvtIoStop;
